...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FetchWageEvent);
}
...
/// @nodoc
class $FetchWageEventCopyWith<$Res>  {
$FetchWageEventCopyWith(FetchWageEvent _, $Res Function(FetchWageEvent) __);
}


/// Adds pattern-matching-related methods to [FetchWageEvent].
extension FetchWageEventPatterns on FetchWageEvent {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _GetWage value)?  getWage,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GetWage() when getWage != null:
return getWage(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _GetWage value)  getWage,}){
final _that = this;
switch (_that) {
case _GetWage():
return getWage(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _GetWage value)?  getWage,}){
final _that = this;
switch (_that) {
case _GetWage() when getWage != null:
return getWage(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  getWage,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GetWage() when getWage != null:
return getWage();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  getWage,}) {final _that = this;
switch (_that) {
case _GetWage():
return getWage();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  getWage,}) {final _that = this;
switch (_that) {
case _GetWage() when getWage != null:
return getWage();case _:
  return null;
...
class _GetWage implements FetchWageEvent {
  const _GetWage();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GetWage);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FetchWageState);
}
...
/// @nodoc
class $FetchWageStateCopyWith<$Res>  {
$FetchWageStateCopyWith(FetchWageState _, $Res Function(FetchWageState) __);
}


/// Adds pattern-matching-related methods to [FetchWageState].
extension FetchWageStatePatterns on FetchWageState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements FetchWageState {
  const _Initial();
...
class _Loading implements FetchWageState {
  const _Loading();
...
class _Empty implements FetchWageState {
  const _Empty();
...
class _Error implements FetchWageState {
...
@override
String toString() {
  return 'FetchWageState.error(err: $err)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $FetchWageStateCopyWith<$Res> {
...
class _HasDataStream implements FetchWageState {
...
@override
String toString() {
  return 'FetchWageState.hasDataStream(data: $data)';
}
...
/// @nodoc
abstract mixin class _$HasDataStreamCopyWith<$Res> implements $FetchWageStateCopyWith<$Res> {
