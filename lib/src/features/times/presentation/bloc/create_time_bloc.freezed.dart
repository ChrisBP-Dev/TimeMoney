...
mixin _$CreateTimeState {
 ...
 ActionState<TimeEntry> get currentState; int get hour; int get minutes;
...
@useResult
$Res call({
 ActionState<TimeEntry> currentState, int hour, int minutes
});
...
as ActionState<TimeEntry>,hour: null == hour ? _self.hour : hour // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ActionState<TimeEntry> currentState,  int hour,  int minutes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateTimeState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ActionState<TimeEntry> currentState,  int hour,  int minutes)  $default,) {final _that = this;
switch (_that) {
case _CreateTimeState():
return $default(_that.currentState,_that.hour,_that.minutes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ActionState<TimeEntry> currentState,  int hour,  int minutes)?  $default,) {final _that = this;
switch (_that) {
case _CreateTimeState() when $default != null:
return $default(_that.currentState,_that.hour,_that.minutes);case _:
  return null;
...
@override final  ActionState<TimeEntry> currentState;
