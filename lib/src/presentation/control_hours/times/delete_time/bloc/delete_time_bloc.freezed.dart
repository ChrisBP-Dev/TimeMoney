...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( ModelTime time)?  delete,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Delete() when delete != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( ModelTime time)  delete,}) {final _that = this;
switch (_that) {
case _Delete():
return delete(_that.time);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( ModelTime time)?  delete,}) {final _that = this;
switch (_that) {
case _Delete() when delete != null:
return delete(_that.time);case _:
  return null;
...
@override $ModelTimeCopyWith<$Res> get time;
