...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function()?  empty,TResult Function( GlobalDefaultFailure err)?  error,TResult Function( Stream<List<ModelTime>> data)?  hasDataStream,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function()  empty,required TResult Function( GlobalDefaultFailure err)  error,required TResult Function( Stream<List<ModelTime>> data)  hasDataStream,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function()?  empty,TResult? Function( GlobalDefaultFailure err)?  error,TResult? Function( Stream<List<ModelTime>> data)?  hasDataStream,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Empty() when empty != null:
...
class _HasDataStream implements ListTimesState {
 ...
 final  Stream<List<ModelTime>> data;
