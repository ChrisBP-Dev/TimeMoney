...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( ModelTime time)?  init,TResult Function( String value)?  changeHour,TResult Function( String value)?  changeMinutes,TResult Function()?  update,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Init() when init != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( ModelTime time)  init,required TResult Function( String value)  changeHour,required TResult Function( String value)  changeMinutes,required TResult Function()  update,}) {final _that = this;
switch (_that) {
case _Init():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( ModelTime time)?  init,TResult? Function( String value)?  changeHour,TResult? Function( String value)?  changeMinutes,TResult? Function()?  update,}) {final _that = this;
switch (_that) {
case _Init() when init != null:
return init(_that.time);case _ChangeHour() when changeHour != null:
return changeHour(_that.value);case _ChangeMinutes() when changeMinutes != null:
...
$ModelTimeCopyWith<$Res> get time {
  ...
  return $ModelTimeCopyWith<$Res>(_self.time, (value) {
...
mixin _$UpdateTimeState {
 ...
 ActionState<ModelTime> get currentState; ModelTime? get time;
...
@useResult
$Res call({
 ActionState<ModelTime> currentState, ModelTime? time
});


$ActionStateCopyWith<ModelTime, $Res> get currentState;$ModelTimeCopyWith<$Res>? get time;
...
as ActionState<ModelTime>,time: freezed == time ? _self.time : time // ignore: cast_nullable_to_non_nullable
as ModelTime?,
  ));
}
/// Create a copy of UpdateTimeState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ActionState<ModelTime> currentState,  ModelTime? time)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateTimeState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ActionState<ModelTime> currentState,  ModelTime? time)  $default,) {final _that = this;
switch (_that) {
case _UpdateTimeState():
return $default(_that.currentState,_that.time);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ActionState<ModelTime> currentState,  ModelTime? time)?  $default,) {final _that = this;
switch (_that) {
case _UpdateTimeState() when $default != null:
return $default(_that.currentState,_that.time);case _:
  return null;
...
class _UpdateTimeState implements UpdateTimeState {
  const _UpdateTimeState({this.currentState = const ActionState<ModelTime>.initial(), this.time = null});
  

@override@JsonKey() final  ActionState<ModelTime> currentState;
@override@JsonKey() final  ModelTime? time;
...
@override $ActionStateCopyWith<ModelTime, $Res> get currentState;@override $ModelTimeCopyWith<$Res>? get time;
