...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FetchWageHourlyEvent);
}
...
/// @nodoc
class $FetchWageHourlyEventCopyWith<$Res>  {
$FetchWageHourlyEventCopyWith(FetchWageHourlyEvent _, $Res Function(FetchWageHourlyEvent) __);
}


/// Adds pattern-matching-related methods to [FetchWageHourlyEvent].
extension FetchWageHourlyEventPatterns on FetchWageHourlyEvent {
...
class _GetWage implements FetchWageHourlyEvent {
  const _GetWage();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FetchWageHourlyState);
}
...
/// @nodoc
class $FetchWageHourlyStateCopyWith<$Res>  {
$FetchWageHourlyStateCopyWith(FetchWageHourlyState _, $Res Function(FetchWageHourlyState) __);
}


/// Adds pattern-matching-related methods to [FetchWageHourlyState].
extension FetchWageHourlyStatePatterns on FetchWageHourlyState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements FetchWageHourlyState {
  const _Initial();
...
class _Loading implements FetchWageHourlyState {
  const _Loading();
...
class _Empty implements FetchWageHourlyState {
  const _Empty();
...
class _Error implements FetchWageHourlyState {
  const _Error(this.err);
  

 final  GlobalDefaultFailure err;

/// Create a copy of FetchWageHourlyState
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $FetchWageHourlyStateCopyWith<$Res> {
...
class _HasDataStream implements FetchWageHourlyState {
...
/// @nodoc
abstract mixin class _$HasDataStreamCopyWith<$Res> implements $FetchWageHourlyStateCopyWith<$Res> {
